...
$string['accesstotallydenied_institutionsuspended'] = 'A sua instituição %s, foi suspensa. Aguarde até que a suspensão seja retirada, será incapaz de efetuar a autenticação em %s.
...
<p>A sua conta em %s irá ser desativada dentro de %s.</p>

<p>Uma vez desativada, não será possível efetuar a autenticação até que um administrador reative a sua conta.</p>

<p>Você pode impedir a sua conta de ser desativada se efetuar a autenticação.</p>

<p>Atentamente, %s o Administrador</p>';
$string['accountinactivewarningtext'] = 'Caro(a) %s,

A sua conta em %s irá ser desativada dentro de %s.

Uma vez desativada, não será possível efetuar a autenticação até que um administrador reative a sua conta.

Você pode impedir a sua conta de ser desativada se efetuar a autenticação.
...
$string['addemail'] = 'Adicionar um endereço de correio eletrónico';
$string['adminofinstitutions'] = 'Administradores de %s';
$string['adminphpuploaderror'] = 'Um erro no envio do ficheiro foi provavelmente causado pela configuração do servidor.';
$string['after'] = 'depois';
$string['allonline'] = 'Mostrar todos os utilizadores ligados';
...
$string['cannotremovedefaultemail'] = 'Você não pode remover o seu endereço de correio eletrónico primário';
...
$string['chooseinstitution'] = 'Escolha a sua instituição';
$string['choosetheme'] = 'Escolha um tema ...';
$string['chooseusernamepassword'] = 'Escolha o seu nome de utilizador e senha';
$string['chooseusernamepasswordinfo'] = 'É necessário um nome de utilizador e senha para efetuar a autenticação em %s. Por favor escolha-os agora.';
...
$string['controlyourprivacylinked'] = 'Verifique a sua <a href="%s">privacidade</a>';
$string['cookiesnotenabled'] = 'O seu browser não tem as cookies ativadas, ou está a bloquear as cookies desta página. As cookies deverão estar ativas antes que possa efetuar a autenticação';
...
$string['dateofbirthformatguide'] = 'Use o formato AAAA/MM/DD';
...
$string['deleteaccount'] = 'Apague a conta de: %s / %s';
...
$string['discusstopicslinked'] = 'Discutir <a href="%s">tópicos</a>';
$string['displayname'] = 'Nome de apresentação';
$string['divertingemailto'] = 'Alteração direcção do correio eletrónico para %s';
$string['done'] = 'Pronto';
$string['edit'] = 'Editar';
...
$string['edittags'] = 'Editar etiquetas';
$string['editthistag'] = 'Editar esta Tag';
$string['email'] = 'Correio eletrónico';
$string['emailaddress'] = 'Endereço de correiro electrónico';
$string['emailaddressdescription'] = ' ';
$string['emailaddressorusername'] = 'Endereço de correio eletrónico ou o nome de utilizador';
$string['emailnotsent'] = 'Falha ao enviar a mensagem de contacto. Mensagem de erro: "%s"';
$string['emailtoolong'] = 'Os endereços de correio eletrónico não podem ter mais de 255 caracteres';
...
$string['forgotpassemailsendunsuccessful'] = 'Desculpe, infelizmente não foi possível enviar esta mensagem com sucesso. Por favor tente novamente em breve.';
$string['forgotpassemailsentanyway1'] = 'Uma mensagem correio eletrónico foi enviada para o endereço de correio eletrónico registado para o utilizador, mas este endereço não deve estar correto ou o servidor do destinatário está devolvendo as mensagens por alguma razão. Entre em contacto com o administrador% s para inicializar a sua senha caso não receba a mensagem.';
$string['forgotpassnosuchemailaddressorusername'] = 'O endereço de correio eletrónico ou nome de utilizador que indicou não pertence a nenhum utilizador desta página';
...
<p>Um pedido de alteração do nome de utilizador/senha foi efetuado para a sua conta em %s.</p>

<p>O seu nome de utilizador é <strong>%s</strong>.</p>

<p>Se desejar efetuar uma limpeza á sua senha, por favor utilize a seguinte hiperligação:</p>

<p><a href="%s">%s</a></p>

<p>Se não efetuou um pedido de limpeza da senha, por favor ignore esta mensagem.</p>
...
Um pedido de alteração do nome de utilizador/senha foi efetuado para a sua conta em %s.

O seu nome de utilizador é %s.

Se desejar limpar a sua senha, por favor utilize a seguinte hiperligação:

%s

Se não efetuou um pedido de limpeza da senha, por favor ignore esta mensagem.
...
$string['forgotusernamepasswordtextprimaryemail'] = '<p>Se se esqueceu do seu nome de utilizador ou da sua senha de acesso introduza o seu endereço de correio eletrónico principal que se encontra listado em primeiro lugar no seu perfil e irá receber uma mensagem que poderá atribuir uma nova senha.</p>
<p>Se sabe o seu nome de utilizador e esqueceu a senha pode também inserir o seu nome de utilizador.</p>';
...
$string['groupquota'] = 'Quota de grupo';
...
$string['institutioncontacts'] = '\'%s\' contactos';
...
$string['institutioninformation'] = 'Informação Institucional';
...
$string['institutionmembershipdescription'] = 'Se for membro de alguma instituição, elas serão listadas aqui. Também pode efetuar pedidos de adesão a Instituições, aceitar ou recusar convites de Instituições.';
...
$string['javascriptnotenabled'] = 'O seu browser não tem o javascript ativo para esta página. O javascript deverá estar ativo antes que possa efetuar a autenticação';
...
$string['lastupdateorcomment'] = 'Última atualização ou comentário';
...
$string['loginto'] = 'Efetuar autenticação em %s';
$string['logout'] = 'Sair';
...
$string['noinstitutionadminfound'] = 'Não foram encontrados administradores da instituição';
$string['noinstitutionoldpassemailmessagehtml'] = '<p>Caro/a %s,</p>
...
<p><a href="%sforgotpass.php">%sforgotpass.php</a></p>';
$string['noinstitutionoldpassemailmessagetext'] = 'Caro/a %s,

Já não é membro de %s.
Pode continuar a utilizar %s com o seu nome de utilizador actual %s, e a senha que definiu para acesso à sua conta.

Se esqueceu a sua senha pode reinicilizá-la na página seguinte inserindo o seu nome de utilizador.

%sforgotpass.php

Se desejar colocar alguma questão em relação ao acima escrito por favor contacte-nos:

%scontact.php

Melhores cumprimentos, %s administrator do sítio

%sforgotpass.php';
$string['noinstitutionoldpassemailsubject'] = '%s: Adesão de %s';
...
$string['noinstitutionstafffound'] = 'Não foram encontrados gestores da instituição';
$string['none'] = 'Nenhum';
$string['noonlineusersfound'] = 'Não foram encontrados utilizadores ligados';
$string['nopublishpermissiononartefact'] = 'Não tem permissão para publicar';
$string['noresultsfound'] = 'Não foram encontrados resultados';
$string['nosendernamefound'] = 'Não foi encontrado o nome do destinatário';
$string['nosessionreload'] = 'Atualize a página para efectuar a autenticação';
...
$string['pluginbrokenanddisabled'] = 'Um utilizador tentou carregar o plugin %s, mas tal não foi possível.
Para prevenir erros futuros, o plugin foi desativado.

A mensagem de erro gerada pelo plugin foi:
----------------------------------------------------------------------------
...
Para reativar o plugin, visite página "Extensões" do seu site.
';
$string['pluginbrokenanddisabledtitle'] = 'Um plugin danificado (%s) foi desativado';
...
$string['primaryemailinvalid'] = 'O endereço de correio eletrónico primário é inválido';
...
$string['registeringdisallowed'] = 'Desculpe, neste momento não é possivel efetuar um registo';
...
$string['registrationcomplete'] = 'Obrigado por efetuar o seu registo em %s';
...
$string['requestmembershipofaninstitution'] = 'Efetuar um pedido de adesão a uma instituição';
...
$string['searchwithin'] = 'Procurar no âmbito';
...
$string['sessiontimedoutpublic'] = 'A sua sessão expirou. Você pode efetuar a <a href="%s">autenticação</a> para continuar a navegar';
$string['sessiontimedoutreload'] = 'A sua sessão expirou. Atualize a página para efetuar a autenticação novamente';
...
$string['show'] = 'Mostrar';
$string['showtags'] = 'Exibir as minhas etiquetas';
$string['siteadministration'] = 'Administração do site';
$string['siteclosed'] = 'O site está temporariamente encerrado para uma atualização da base de dados. Os administradores podem efetuar a autenticação.';
$string['siteclosedlogindisabled'] = 'O site está temporariamente fechado para uma atualização da base de dados.  <a href="%s">Efetuar a atualização agora.</a>';
$string['sitecontentnotfound'] = 'O texto %s, não está disponível';
$string['siteinformation'] = 'Informação do site';
$string['sizeb'] = 'b';
$string['sizegb'] = 'GB';
$string['sizekb'] = 'KB';
$string['sizemb'] = 'MB';
$string['sortalpha'] = 'Ordenar etiquetas alfabeticamente';
$string['sortfreq'] = 'Ordenar etiquetas por frequência';
$string['sortresultsby'] = 'Ordenar resultados por:';
$string['spamtrap'] = 'Armadilha de Spam';
$string['staffofinstitutions'] = 'Gestores de %s';
...
$string['tagsdesc'] = 'Introduza as etiquetas para este item, separadas por virgulas.';
$string['tagsdescprofile'] = 'Introduza as etiquetas para este item separadas por virgulas. Os itens marcados com \'profile\' estão visíveis na barra lateral.';
...
%s';
$string['youraccounthasbeensuspendedtext2'] = 'A sua conta em %s foi suspensa por %s.';
$string['youraccounthasbeenunsuspended'] = 'A suspensão da sua conta foi retirada';
$string['youraccounthasbeenunsuspendedtext2'] = 'A suspensão da sua conta em %s foi retirada. Pode efetuar a autenticação novamente e utilizar a página.';
